...
(4,	'Fruit Medley',	1,	1,	3,	'Dessert',	''),
(7,	'Lobster Thermidor',	1,	1,	1,	'Non Vegetarian Starter',	''),
(2,	'Oven Roasted ',	1,	2,	2,	'Non Vegetarian Main Course',	''),
(6,	'Smoked salmon gateau',	1,	2,	1,	'Non Vegetarian Starter',	''),
